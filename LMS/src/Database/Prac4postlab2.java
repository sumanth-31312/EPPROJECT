...
public class Prac4postlab2 {
	public static void main(String[] args) throws IOException {
		...
		i++;
		File f=new
		File("C:\\Users\\susha\\OneDrive\\Desktop\\animal\\animal" + i + ".jpg");
		...
		(int)blob.length());
		 ...
		 File f0=new
		File("C:\\Users\\susha\\OneDrive\\Desktop\\animal\\animal " + i + ".txt");
		...
		j++;
		File f1=new
		File("C:\\Users\\susha\\OneDrive\\Desktop\\plant\\plant " + j + ".jpg");
		FileOutputStream image=new FileOutputStream(f1);
		b1=rs1.getBlob("image");
		by = b1.getBytes(1, (int)b1.length());
		image.write(by);
		File f2=new
		File("C:\\Users\\susha\\OneDrive\\Desktop\\plant\\plant " + j + ".txt");
